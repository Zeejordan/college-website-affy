...
const AboutUs = () => {
  ...
  return (
    <>
      <div className="d-flex flex-column mx-0 flex-md-row">
        <div className="container-fluid p-0 d-flex align-items-center justify-content-between">
          {/* Row Container */}
          <div className="row w-100 mx-0">
            {/* Left Side - Text Content */}
            <div className="col-12 col-md-5 d-flex flex-column border justify-content-center align-items-center align-items-md-start order-2 order-md-1 text-center text-md-start">
                ...
                <div className="d-flex justify-content-start w-100">
                  {contentArray.map((_, index) => (
                    <div
                      ...
                      className={`mx-1 cursor-pointer ${currentIndex === index ? "bg-danger" : "bg-secondary"}`}
                      style={{
                        height: "4px",
                        width: "38px",
                        borderRadius: "10%",
            ...
            <motion.div
              className="col-12 col-md-7 p-0 d-flex justify-content-center align-items-center order-1 order-md-2"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
        ...
        {/* <div className="col-12 col-md-2 position-sticky">
          <ImportantLinks />
          <Notice/>
        </div> */}
      </div>
